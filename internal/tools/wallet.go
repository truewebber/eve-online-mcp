...
func registerWallet(s *mcp.Server, a *app.App) {
	type histIn struct {
...
func journalSection(a *app.App, cid int, refType string, limit int, conciseMode bool) (map[string]any, error) {
...
func transactionSection(a *app.App, path string, cid int, limit int, conciseMode bool) (map[string]any, error) {
...
func summarizeTransactions(a *app.App, cid int, data any, stale string, truncated bool, limit int, conciseMode bool) (map[string]any, error) {
	entries := j.Maps(data)
	if len(entries) == 0 {
