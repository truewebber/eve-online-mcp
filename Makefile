...
test-store: postgres migrate
	DATABASE_URL=$(DATABASE_URL) $(GO) test ./internal/postgres ./internal/postgres/pgtest ./internal/adapter/sso ./internal/adapter/sso/http ./internal/adapter/esi ./internal/adapter/esi/http ./internal/usecase/oauth ./internal/usecase/session ./internal/domain/write ./internal/domain/character/pgx ./internal/domain/oauthclient/pgx ./internal/domain/loginstate/pgx ./internal/domain/authcode/pgx ./internal/domain/confirm/pgx ./internal/domain/mutation/pgx -count=1
